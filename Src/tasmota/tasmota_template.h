...
enum SupportedModules {
  RFTV1,MSSV1,SONOFF_BASIC, SONOFF_RF, SONOFF_SV, SONOFF_TH, SONOFF_DUAL, SONOFF_POW, SONOFF_4CH, SONOFF_S2X, SLAMPHER, SONOFF_TOUCH,
...
const char kModuleNames[] PROGMEM =
  "RFTV1|MSSV1|Sonoff Basic|Sonoff RF|Sonoff SV|Sonoff TH|Sonoff Dual|Sonoff Pow|Sonoff 4CH|Sonoff S2X|Slampher|Sonoff Touch|"
...
enum SupportedTemplates8285 {
  TMP_RFTV1,TMP_MSSV1,TMP_SONOFF_BASIC, TMP_SONOFF_SV, TMP_SONOFF_DUAL, TMP_SONOFF_POW, TMP_SONOFF_LED, TMP_ELECTRODRAGON,
...
const mytmplt8266 kModules8266[TMP_MAXMODULE_8285] PROGMEM = {
    ...
    GPIO_LED1,  //GPIO_LEDLNK,          // GPIO04 Optional sensor
    GPIO_BUZZER,                  // GPIO05
                        // GPIO06 (SD_CLK   Flash)
                        ...
                        // GPIO11 (SD_CMD   Flash)
    GPIO_KEY1_INV,          // GPIO12 Red Led and Relay (0 = Off, 1 = On)
    GPIO_RFSEND,      // GPIO13 Green Led (0 = On, 1 = Off) - Link and Power status
    GPIO_RFRECV,          // GPIO14 Optional sensor
    0,                  // GPIO15
    0,                  // GPIO16
    0                   // ADC0 Analog input
  },
    ...
    0,          // GPIO00 Button
    0,          // GPIO01 Serial RXD and Optional sensor
    GPIO_KEY1,          // GPIO02 Only available on newer Sonoff Basic R2 V1
    0,          // GPIO03 Serial TXD and Optional sensor
    ...
    GPIO_LEDLNK,      // GPIO13 Green Led (0 = On, 1 = Off) - Link and Power status
